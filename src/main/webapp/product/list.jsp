            ...
            <div class="col">
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a href="/products?action=create">
                        <button class="btn btn-primary me-md-2" type="button"><i class="fas fa-plus"></i> Add new
                            Product
                        </button>
                    </a>
                </div>
                        ...
                        <c:forEach var="product" items="${products}" varStatus="loop">
                            <tr>
                                ...
                                <td><a href="/products?action=edit&id=${product.id}">
                                    <button type="button" class="btn btn-primary"><i class="far fa-edit"></i> Edit
                                    </button>
                                </a></td>
                                <td><a href="/products?action=delete&id=${product.id}">
                                    <button type="button" class="btn btn-danger"><i class="fas fa-eraser"></i> Delete
                                    </button>
                                </a></td>
                            </tr>
                        </c:forEach>
